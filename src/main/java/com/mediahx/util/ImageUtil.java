...
public final class ImageUtil {
	 ...
	 * @throws IOException
	 */
	public static boolean getCombinationOfhead(List<String> paths, String outdir) throws IOException {
		...
		StringBuffer outPath = new StringBuffer().append(outdir);
	...
	public static StringBuffer httpsRequest(String requestUrl, String dir) throws NoSuchAlgorithmException, NoSuchProviderException, KeyManagementException, MalformedURLException,
