...
public class DateUtils {
	 ...
	 * @return
	 */
	public static boolean checkDateInRange(Date start, Date check, Date end) {
		boolean flag = false;
		long startM = start.getTime();
		long checkM = check.getTime();
	...
	// Date a = DateUtils.getBeginDayOfMonth();
	// System.err.println(formatter.format(a));
	// }
